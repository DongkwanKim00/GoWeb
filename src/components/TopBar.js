...
>
      ...
      <Navbar.Collapse id="basic-navbar-nav" className="text-center w-100">
        <Nav className="mx-auto">
          <Nav.Link href="/news" className="forTopBarFont" style={{ fontSize: "56px" }}>News</Nav.Link>
          <Nav.Link href="/rank" className="forTopBarFont" style={{ fontSize: "56px" }}>Rank</Nav.Link>
          <Nav.Link href="/products" className="forTopBarFont" style={{ fontSize: "56px" }}>Products</Nav.Link>
